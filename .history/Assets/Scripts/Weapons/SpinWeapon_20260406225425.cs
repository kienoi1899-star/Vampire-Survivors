...
public class SpinWeapon : Weapon
{
    ...
    private Transform fireballPrefab;  // ✅ Cache prefab để dùng lại
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("❌ SpinWeapon: fireballToSpawn chưa được assign!");
        }
        SetStats();
    }
    ...
    void Update()
    {
        ...
        if (fireballToSpawn == null)
        {
            Debug.LogError("❌ SpinWeapon: fireballToSpawn is NULL!");
            return;
        }
